...
export default function ReachLocation({locationInfo}:Props) {
	...
	return (
		<>
		<div className='w-full flex items-center justify-between p-2 h-[70px] bg-opacity-65 bg-black'>
			<button className='bg-myColors2-50 w-[50px] h-[50px] flex items-center justify-center rounded-[20px]' onClick={OpenTheModal}>
		...
		{modalOfReach && <ReachLocationModal setModalOfReach={setModalOfReach} handleClick={handleClick} count={count} close={close}/>}
